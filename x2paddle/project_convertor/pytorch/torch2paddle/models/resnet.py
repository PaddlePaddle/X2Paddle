...
model_urls = {
    ...
    'resnet101': 'https://x2paddle.bj.bcebos.com/vision/models/resnet101-pt.pth',
    'resnet152': 'https://x2paddle.bj.bcebos.com/vision/models/resnet152-pt.pth',
    'resnext50_32x4d': 'https://x2paddle.bj.bcebos.com/vision/models/resnext50_32x4d-pt.pth',
    'resnext101_32x8d': 'https://x2paddle.bj.bcebos.com/vision/models/resnext101_32x8d-pt.pth',
    'wide_resnet50_2': 'https://x2paddle.bj.bcebos.com/vision/models/wide_resnet50_2-pt.pth',
    'wide_resnet101_2': 'https://x2paddle.bj.bcebos.com/vision/models/wide_resnet101_2-pt.pth',
}
        ...
        if zero_init_residual:
            for m in self.sublayers():
                if isinstance(m, Bottleneck):
                    torch2paddle.constant_init_(m.bn3.weight, 0)  # type: ignore[arg-type]
                elif isinstance(m, BasicBlock):
                    torch2paddle.constant_init_(m.bn2.weight, 0)  # type: ignore[arg-type]
