...
class BatchNorm1D(paddle.nn.BatchNorm1D):
    def __init__(self, num_features, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True):
        ...
        super().__init__(num_features, momentum=momentum, epsilon=eps, weight_attr=weight_attr, 
                         bias_attr=bias_attr, use_global_stats=track_running_stats)
...
class Embedding(paddle.nn.Embedding):
    def __init__(self, num_embeddings, embedding_dim, padding_idx=None, 
        ...
        super().__init__(num_embeddings, embedding_dim, padding_idx=padding_idx, sparse=sparse)
...
class Linear(paddle.nn.Linear):
    def __init__(self, in_features, out_features, bias=True):
        super().__init__(in_features, out_features, bias_attr=bias if not bias else None)

class MaxPool1D(paddle.nn.MaxPool1D):
    def __init__(self, kernel_size, stride=None, padding=0, dilation=1, return_indices=False, ceil_mode=False):
        super().__init__(kernel_size, stride=stride, padding=padding, ceil_mode=ceil_mode, return_mask=return_indices)
