...
NN_MAPPER = {"torch.nn": ["paddle.nn", None],
             ...
             "torch.nn.InstanceNorm2d": ["paddle.nn.InstanceNorm2D", ClassBatchNorm],
             ...
             "torch.nn.functional.binary_cross_entropy_with_logits": [
                                 "x2paddle.torch2paddle.binary_cross_entropy_with_logits", 
                                 FuncBinaryCrossEntropyLogits],
...
UTILS_MAPPER = {"torch.utils.data": ["paddle.io", None],
                "torch.utils.data.DataLoader": ["paddle.io.DataLoader", ClassDataLoader], 
