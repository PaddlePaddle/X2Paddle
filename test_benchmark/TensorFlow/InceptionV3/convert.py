...
def freeze_model(sess, output_tensor_names, var_names_whitelist, freeze_model_path):
...
freeze_model(sess, ["InceptionV3/Logits/Conv2d_3new_1x1/BiasAdd"], var_names_whitelist, save_pb_file)