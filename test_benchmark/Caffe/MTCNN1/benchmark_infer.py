...
def main(args):
    with open('../dataset/MTCNN1/caffe_input.pkl', 'rb') as inp:
        input_data = pickle.load(inp)["data0"]
    with open('../dataset/MTCNN1/caffe_output.pkl', 'rb') as oup:
        caffe_result = pickle.load(oup)["prob1"][0]
    ...
    benchmark_pipeline.run_benchmark(data=input_data,
                                     caffe_result=caffe_result,
                                     warmup=1,
                                     repeats=1)
