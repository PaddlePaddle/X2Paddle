...
def preprocess_dataset(datasets_root: Path, out_dir: Path, n_processes: int,
    ...
    input_dirs = [
        dataset_root.joinpath(subfolder.strip())
        for subfolder in dataset_info["subfolders"]
    ]
    ...
    metadata_file = metadata_fpath.open("a" if skip_existing else "w",
                                        encoding="utf-8")
    ...
    func = partial(dataset_info["speak_func"],
                   out_dir=out_dir,
