...
class Synthesizer:
    ...
    def load(self):
        ...
        """
        print("------test_wjj----:", hparams.tts_dropout)
    ...
    def synthesize_spectrograms(self,
        ...
        texts = [
            " ".join(
                lazy_pinyin(v, style=Style.TONE3, neutral_tone_with_five=True))
            for v in texts
        ]
        print("Synthesizing " + str(texts))
        # Preprocess text inputs
        inputs = [
            text_to_sequence(text, hparams.tts_cleaner_names) for text in texts
        ]
