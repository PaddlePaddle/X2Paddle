...
def preprocess_speaker_general(speaker_dir, out_dir: Path, skip_existing: bool,
                               hparams, dict_info, no_alignments: bool):
    metadata = []
    ...
    for extension in extensions:
        ...
        for wav_fpath in wav_fpath_list:
            ...
            words = dict_info.get(
                wav_fpath.name) if not words else words  # try with wav
            if not words:
                print("no wordS")
                continue
            ...
            metadata.append(
                _process_utterance(wav, text, out_dir, sub_basename,
