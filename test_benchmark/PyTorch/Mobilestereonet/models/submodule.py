...
def interweave_tensors(refimg_fea, targetimg_fea):
    ...
    # interwoven_features = torch.zeros([B, 2 * C, H, W])
    # print("interwoven_features:", interwoven_features.shape)
    # print("refimg_fea:", refimg_fea.shape)
    # print("targetimg_fea:", targetimg_fea.shape)
