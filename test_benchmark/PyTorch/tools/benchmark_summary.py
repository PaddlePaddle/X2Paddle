...
def benchmark_info(file_name, model_name, inference_success, inference_failed,
...
def main():
    ...
    for model_name in all_model_names:
        # gpu + trt
        file_name = '../output/' + model_name + '_trace_gpu_tensorrt.log'
        benchmark_info(file_name, model_name, inference_success_trt,
                       inference_failed_trt, compare_success_trt,
                       compare_failed_trt)
        # gpu
        file_name = '../output/' + model_name + '_trace_gpu.log'
        benchmark_info(file_name, model_name, inference_success_gpu,
                       inference_failed_gpu, compare_success_gpu,
                       compare_failed_gpu)
        # cpu_mkldnn
        file_name = '../output/' + model_name + '_trace_cpu_mkldnn.log'
        benchmark_info(file_name, model_name, inference_success_mkldnn,
                       inference_failed_mkldnn, compare_success_mkldnn,
                       compare_failed_mkldnn)
        # cpu
        file_name = '../output/' + model_name + '_trace_cpu.log'
        benchmark_info(file_name, model_name, inference_success_cpu,
                       inference_failed_cpu, compare_success_cpu,
                       compare_failed_cpu)
    # Init logger
    log_output = '../output/' + model_name + '_summary.log'
    ...
    logger.info(f"Paddle Inference benchmark log will be saved to {log_output}")
    logger.info("\n")
    logger.info("--------------------------------------------------------")
    logger.info("                     trt     gpu     mkldnn      cpu    ")
    logger.info(
    ...
    logger.info(f"Models list of run trt failed: {inference_failed_trt}")
    logger.info("--------------------------------------------------------")
    logger.info(f"models list of trt accu compare failed: {compare_failed_trt}")
    logger.info("--------------------------------------------------------")
    logger.info(f"models list of run gpu failed: {inference_failed_gpu}")
    logger.info("--------------------------------------------------------")
    logger.info(f"models list of gpu accu compare failed: {compare_failed_gpu}")
    logger.info("--------------------------------------------------------")
    logger.info(f"models list of run mkldnn failed: {inference_failed_mkldnn}")
    logger.info("--------------------------------------------------------")
    logger.info(
        f"models list of mkldnn accu compare failed: {compare_failed_mkldnn}")
    logger.info("--------------------------------------------------------")
    logger.info(f"models list of run cpu failed: {inference_failed_cpu}")
    logger.info("--------------------------------------------------------")
    logger.info(f"models list of cpu accu compare failed: {compare_failed_cpu}")
    logger.info("--------------------------------------------------------")
