...
def main(args):
    with open('../dataset/XLMRobertaForTokenClassification/pytorch_input.pkl',
              'rb') as inp:
        data = pickle.load(inp)
    pytorch_result = np.load(
        "../dataset/XLMRobertaForTokenClassification/output.npy")
    benchmark_pipeline = BenchmarkPipeline(
        model_dir="pd_model/inference_model/",
        model_name='XLMRobertaForTokenClassification_trace',
