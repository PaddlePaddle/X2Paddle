...
def main(args):
    inputs_data = np.load("../dataset/mobilenetv3/input.npy")
    pytorch_result = np.load("../dataset/mobilenetv3/output.npy")
    ...
    benchmark_pipeline.run_benchmark(data=inputs_data, pytorch_result=pytorch_result, warmup=1, repeats=1)
