...
def _compute_statistics_of_images(images,
                                  model,
                                  batch_size,
                                  dims,
                                  cuda,
    ...
    if isinstance(images, list):  # exact paths to files are provided
        m, s = calculate_activation_statistics(images,
                                               model,
                                               batch_size,
                                               dims,
                                               cuda,
...
def calculate_fid_given_images(images,
                               batch_size,
                               cuda,
                               dims,
                               use_globals=False,
    ...
    m1, s1 = _compute_statistics_of_images(images[0],
                                           model,
                                           batch_size,
                                           dims,
                                           cuda,
                                           keep_size=False)
    m2, s2 = _compute_statistics_of_images(images[1],
                                           model,
                                           batch_size,
                                           dims,
                                           cuda,
