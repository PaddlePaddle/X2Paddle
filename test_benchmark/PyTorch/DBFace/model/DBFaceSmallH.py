    ...
    def __init__(self, in_size, reduction=4):
        ...
        self.se = nn.Sequential(
            ...
            nn.Conv2d(in_size // reduction,
                      ...
                      stride=1,
                      padding=0,
                      bias=False), nn.BatchNorm2d(in_size), nn.Sigmoid())
...
class Mbv3SmallFast(nn.Module):
    ...
    def __init__(self):
        ...
        self.bneck = nn.Sequential(
            ...
            Block(5, 48, 144, 48, nn.ReLU(inplace=True), SeModule(48),
                  1),  # 7 *
    ...
    def load_pretrain(self):
        checkpoint = model_zoo.load_url(
            f"{_MODEL_URL_DOMAIN}/{_MODEL_URL_SMALL}")
...
class UpModule(nn.Module):
    ...
    def __init__(self,
        ...
        if self.mode == "UCBA":
            ...
            self.conv = CBAModule(in_channels,
                                  out_channels,
                                  3,
                                  padding=1,
                                  bias=bias)
            ...
            self.dconv = nn.ConvTranspose2d(in_channels,
                                            ...
                                            stride,
                                            bias=bias)
            self.conv = CBAModule(out_channels,
                                  out_channels,
                                  3,
                                  padding=1,
                                  bias=bias)
...
class HeadModule(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, has_ext=False):
        ...
        if has_ext:
            self.ext = CBAModule(in_channels,
                                 in_channels,
                                 kernel_size=3,
                                 padding=1,
                                 bias=False)
...
class DBFace(nn.Module):
    ...
    def __init__(self, has_landmark=True, wide=64, has_ext=True, upmode="UCBA"):
        ...
        self.conv3 = CBAModule(self.bb.output_channels,
                               wide,
                               kernel_size=1,
                               stride=1,
                               padding=0,
        ...
        self.up0 = UpModule(wide, wide, kernel_size=2, stride=2,
                            mode=upmode)  # s16
        self.up1 = UpModule(wide, wide, kernel_size=2, stride=2,
                            mode=upmode)  # s8
        self.up2 = UpModule(wide, wide, kernel_size=2, stride=2,
                            mode=upmode)  # s4
