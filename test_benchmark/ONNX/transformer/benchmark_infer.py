...
def main(args):
    data_0 = np.load('../dataset/transformer/input_0.npy')
    data_1 = np.load('../dataset/transformer/input_1.npy')
    data = dict()
    data['input0'] = data_0
    data['input1'] = data_1
    onnx_result = np.load('../dataset/transformer/result.npy')
    ...
    benchmark_pipeline.run_benchmark(data=data, onnx_result=onnx_result, warmup=1, repeats=1)
